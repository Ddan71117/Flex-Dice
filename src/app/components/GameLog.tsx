...
export default function GameLog() {
  ...
  return (
    <div>
      <button
        onClick={openModal}
        className="fixed bottom-4 right-4 h-14 px-6 m-2 text-lg text-black transition-colors duration-150 bg-teal-500 rounded-lg focus:shadow-outline hover:bg-teal-600"
      >
        Show Game Log
      </button>
